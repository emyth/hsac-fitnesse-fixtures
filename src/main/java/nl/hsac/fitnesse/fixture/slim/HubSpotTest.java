 ...
 */
public class HubSpotTest extends HttpTest {
    ...
    public boolean getContactByEmail(String email) {
      String serviceUrl = "https://api.hubapi.com/contacts/v1/contact/email/startcomp6@test.com/profile?hapikey=6f8c33b5-e84e-4ffe-b371-05242ac4ea1f";
      return getFrom(serviceUrl);
    } 
